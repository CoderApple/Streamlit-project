...
st.markdown("<h1 style='text-align: center; color: black; background-image: radial-gradient(circle, #051937, #004d7a, #008793, #00bf72, #a8eb12);'>CalcGPA</h1>", unsafe_allow_html=True)
